...
#ifndef CITYBUILD_GUI_H
#define CITYBUILD_GUI_H
...
public:
    ...
    GuiStyle(sf::Font* font, float borderSize, sf::Color bodyCol, sf::Color borderCol, sf::Color textCol,
